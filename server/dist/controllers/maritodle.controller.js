...
exports.insertTrainers = exports.desistir = exports.submeterPalpite = exports.novoJogo = exports.getNomes = void 0;
...
function gerarFeedback(palpite, segredo) {
    ...
    const extrairNumeroContribuicoes = (trofeus) => {
        var _a;
        if (!trofeus || trofeus.length === 0)
            return 0;
        const match = (_a = trofeus[0]) === null || _a === void 0 ? void 0 : _a.match(/(\d+)/);
...
function analisarHistoricoTentativas(historico, segredo) {
    ...
    historico.forEach(tentativa => {
        if (tentativa.feedback) {
            tentativa.feedback.forEach((feedback, index) => {
...
function gerarDicaInteligente(segredo, historico, tentativasRealizadas, atributoExcluido = null) {
...
function gerarDicaPorAtributo(atributo, segredo, status) {
...
function gerarClue1Generica(segredo) {
...
function buscarJogadoresMaritimo() {
    ...
    `);
            ...
            const verificarSeJogador = (nomeTrainador) => __awaiter(this, void 0, void 0, function* () {
            ...
            const jogadores = yield Promise.all(result.rows.map((row) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (row.papel === 'Treinador') {
                    ...
                    posicoes = row.posicao_principal ? row.posicao_principal.split('/').map((pos) => pos.trim()) : ['N/A'];
                }
                // Determinar papel baseado no histórico
                let papeis = [row.papel];
                if (row.papel === 'Treinador') {
                    const foiJogador = yield verificarSeJogador(row.nome);
                    if (foiJogador) {
...
function obterJogadores() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        // Atualizar cache
        jogadoresCache = yield buscarJogadoresMaritimo();
...
const getNomes = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const jogadores = yield obterJogadores();
...
const novoJogo = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const submeterPalpite = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (!jogosAtivos[userId]) {
            throw new errorTypes_1.BadRequestError('Nenhum jogo ativo. Inicie um novo jogo.');
        }
        const jogo = jogosAtivos[userId];
        if (jogo.finalizado) {
            throw new errorTypes_1.BadRequestError('Jogo já finalizado');
        }
        // Obter jogadores atualizados
        const jogadores = yield obterJogadores();
        ...
        if (!palpite) {
            throw new errorTypes_1.BadRequestError('Jogador/Treinador não encontrado.');
        }
...
const desistir = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const userId = req.userId;
        if (!jogosAtivos[userId]) {
...
exports.desistir = desistir;
const insertTrainers = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const trainers = [
        ...
        `, trainer);
                ...
                console.log(`Erro ao inserir ${trainer[0]}:`, error.message);
            }
        }
        res.json({
...
exports.insertTrainers = insertTrainers;
